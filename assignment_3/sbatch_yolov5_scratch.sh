#!/bin/bash
#SBATCH --job-name=yolov5m_voc_scratch
#SBATCH --partition=gpu 
#SBATCH --gres=gpu:tesa100:1 
#SBATCH --cpus-per-task=4
#SBATCH --mem=75G
#SBATCH --time=10:00:00
#SBATCH --output=/users/jmatthia/deep_learning/code/assignment_3/yolo_v5_training_scratch_%j.out
